// AUTO-GENERATED by scripts/generate-options.mjs from renovate@44.115.10.
...
export const OPTIONS: Record<string, GeneratedOption> = {
  ...
  "allowInternal": {
    "description": "Whether requests to this host may reach internal addresses when `internalHostAccess=block`. Only honored from the self-hosted administrator's own configuration, or from inherited config when `inheritConfigTrusted=true`.",
    "type": "boolean",
    "globalOnly": true,
    "parents": [
      "hostRules"
  ...
  "exitCodeForErrors": {
    "description": "Exit with an error-specific exit code when a repository run ends in a known error state.",
    "type": "boolean",
    "default": false,
    "globalOnly": true,
    "experimental": true
  ...
  "inheritConfigTrusted": {
    "description": "If `true`, `hostRules` in inherited config may grant access to internal hosts.",
    "type": "boolean",
    "default": false,
    "globalOnly": true,
    "experimental": true,
  ...
  "internalHostAccess": {
    "description": "Whether Renovate may make HTTP requests to internal hosts, such as loopback, private-range and link-local addresses. `warn` logs the requests which `block` would refuse.",
    "type": "string",
    "default": "warn",
    "allowedValues": [
      "allow",
  ...
  "matchIsBreaking": {
    "description": "Matches only if the update is considered breaking (e.g. major, or minor for 0.x in ecosystems like Cargo) when `true`, or non-breaking when `false`. Valid only within a `packageRules` object.",
    "type": "boolean",
    "parents": [
      "packageRules"
    ],
  ...
  "minimumReleaseAgeBuffer": {
    "description": "Extra time added to `minimumReleaseAge` before an update is considered stable.",
    "type": "string",
    "default": "30 minutes"
  },
  "minor": {
