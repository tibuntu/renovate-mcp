// AUTO-GENERATED by scripts/generate-presets.mjs from renovate@44.115.10.
...
export const PRESETS: Record<string, GeneratedPreset> = {
  ...
  "customManagers:valeVersions": {
    "namespace": "customManagers",
    "description": "Update Vale package versions in `.vale.ini` configuration files.",
    "body": {
      "customManagers": [
        {
          "customType": "regex",
  ...
  "group:arrow-rsMonorepo": {
    "namespace": "group",
    "description": null,
    "body": {
      "packageRules": [
        {
          "description": "Group packages from arrow-rs monorepo together.",
          "extends": [
            "monorepo:arrow-rs"
          ],
          "groupName": "arrow-rs monorepo",
          "matchUpdateTypes": [
            "digest",
            "patch",
            "minor",
  ...
  "group:better-authMonorepo": {
    "namespace": "group",
    "description": null,
    "body": {
      "packageRules": [
        {
          "description": "Group packages from better-auth monorepo together.",
          "extends": [
            "monorepo:better-auth"
          ],
          "groupName": "better-auth monorepo",
          "matchUpdateTypes": [
            "digest",
            "patch",
            "minor",
  ...
  "group:confectMonorepo": {
    "namespace": "group",
    "description": null,
    "body": {
      "packageRules": [
        {
          "description": "Group packages from confect monorepo together.",
          "extends": [
            "monorepo:confect"
          ],
          "groupName": "confect monorepo",
          "matchUpdateTypes": [
            "digest",
            "patch",
            "minor",
  ...
  "group:convexMonorepo": {
    "namespace": "group",
    "description": null,
    "body": {
      "packageRules": [
        {
          "description": "Group packages from convex monorepo together.",
          "extends": [
            "monorepo:convex"
          ],
          "groupName": "convex monorepo",
          "matchUpdateTypes": [
            "digest",
            "patch",
            "minor",
  ...
  "group:error-prone-supportMonorepo": {
    "namespace": "group",
    "description": null,
    "body": {
      "packageRules": [
        {
          "description": "Group packages from error-prone-support monorepo together.",
          "extends": [
            "monorepo:error-prone-support"
          ],
          "groupName": "error-prone-support monorepo",
          "matchUpdateTypes": [
            "digest",
            "patch",
            "minor",
  ...
  "group:flueMonorepo": {
    ...
    "body": {
      "packageRules": [
        {
          "description": "Group packages from flue monorepo together.",
          "extends": [
            "monorepo:flue"
          ],
          "groupName": "flue monorepo",
          "matchUpdateTypes": [
            "digest",
            "patch",
            "minor",
  ...
  "group:graphql-platformMonorepo": {
    "namespace": "group",
    "description": null,
    "body": {
      "packageRules": [
        {
          "description": "Group packages from graphql-platform monorepo together.",
          "extends": [
            "monorepo:graphql-platform"
          ],
          "groupName": "graphql-platform monorepo",
          "matchUpdateTypes": [
            "digest",
            "patch",
            "minor",
  ...
  "group:jsonformsMonorepo": {
    "namespace": "group",
    "description": null,
    "body": {
      "packageRules": [
        {
          "description": "Group packages from jsonforms monorepo together.",
          "extends": [
            "monorepo:jsonforms"
          ],
          "groupName": "jsonforms monorepo",
          "matchUpdateTypes": [
            "digest",
            "patch",
            "minor",
  ...
  "group:juniorMonorepo": {
    "namespace": "group",
    "description": null,
    "body": {
      "packageRules": [
        {
          "description": "Group packages from junior monorepo together.",
          "extends": [
            "monorepo:junior"
          ],
          "groupName": "junior monorepo",
          "matchUpdateTypes": [
            "digest",
            "patch",
            "minor",
  ...
  "group:recommended": {
    ...
    "body": {
      ...
      "overrideDescription": "Use curated list of recommended non-monorepo package groupings."
    }
  },
  "group:redwoodMonorepo": {
    "namespace": "group",
  ...
  "group:serwistMonorepo": {
    ...
    "body": {
      "packageRules": [
        {
          "description": "Group packages from serwist monorepo together.",
          "extends": [
            "monorepo:serwist"
          ],
  ...
  "group:size-limitMonorepo": {
    ...
    "body": {
      "packageRules": [
        {
          "description": "Group packages from size-limit monorepo together.",
          "extends": [
            "monorepo:size-limit"
          ],
  ...
  "group:solidMonorepo": {
    ...
    "body": {
      "packageRules": [
        {
          "description": "Group packages from solid monorepo together.",
          "extends": [
            "monorepo:solid"
          ],
  ...
  "group:tomcatMonorepo": {
    ...
    "body": {
      "packageRules": [
        {
          "description": "Group packages from tomcat monorepo together.",
          "extends": [
            "monorepo:tomcat"
          ],
          "groupName": "tomcat monorepo",
          "matchUpdateTypes": [
            "digest",
            "patch",
            "minor",
  ...
  "group:tunitMonorepo": {
    ...
    "body": {
      "packageRules": [
        {
          "description": "Group packages from tunit monorepo together.",
          "extends": [
            "monorepo:tunit"
          ],
          "groupName": "tunit monorepo",
          "matchUpdateTypes": [
            "digest",
            "patch",
            "minor",
  ...
  "group:vite-plusMonorepo": {
    ...
    "body": {
      "packageRules": [
        {
          "description": "Group packages from vite-plus monorepo together.",
          "extends": [
            "monorepo:vite-plus"
          ],
  ...
  "group:vue-language-toolsMonorepo": {
    ...
    "body": {
      "packageRules": [
        {
          "description": "Group packages from vue-language-tools monorepo together.",
          "extends": [
            "monorepo:vue-language-tools"
          ],
          "groupName": "vue-language-tools monorepo",
          "matchUpdateTypes": [
            "digest",
            "patch",
            "minor",
  ...
  "group:yamldotnetMonorepo": {
    ...
    "body": {
      "packageRules": [
        {
          "description": "Group packages from yamldotnet monorepo together.",
          "extends": [
            "monorepo:yamldotnet"
          ],
          "groupName": "yamldotnet monorepo",
          "matchUpdateTypes": [
            "digest",
            "patch",
            "minor",
      ...
      "packageRules": [
        {
          ...
          "matchJsonata": [
            "$detectPlatform(sourceUrl) = 'gitlab'"
          ],
          "matchUpdateTypes": [
            "digest"
          ]
      ...
      "packageRules": [
        {
          ...
          "prBodyDefinitions": {
            "Change": "[`{{{displayFrom}}}` → `{{{displayTo}}}`](https://octochangelog.com/compare?repo=renovatebot%2Frenovate&from={{ currentVersion }}&to={{ newVersion }})"
          }
        }
      ]
    }
  ...
  "monorepo:better-auth": {
    "namespace": "monorepo",
    "description": "better-auth monorepo",
    "body": {
      "matchSourceUrls": [
  ...
  "monorepo:error-prone-support": {
    "namespace": "monorepo",
    "description": "error-prone-support monorepo",
    "body": {
      "matchSourceUrls": [
  ...
  "monorepo:graphql-platform": {
    "namespace": "monorepo",
    "description": "graphql-platform monorepo",
    "body": {
      "matchSourceUrls": [
  ...
  "monorepo:jsonforms": {
    "namespace": "monorepo",
    "description": "jsonforms monorepo",
    "body": {
      "matchSourceUrls": [
  ...
  "monorepo:vite-plus": {
    "namespace": "monorepo",
    "description": "vite-plus monorepo",
    "body": {
      "matchSourceUrls": [
  ...
  "monorepo:vue-language-tools": {
    "namespace": "monorepo",
    "description": "vue-language-tools monorepo",
    "body": {
      "matchSourceUrls": [
  ...
  "monorepo:yamldotnet": {
    "namespace": "monorepo",
    "description": "yamldotnet monorepo",
    "body": {
      "matchSourceUrls": [
  ...
  "replacements:all": {
    ...
    "body": {
      "extends": [
        ...
        "replacements:aws-sdk-smithy-client-to-smithy",
        ...
        "replacements:dev-oidc-provider-to-unscoped",
        "replacements:dev-process-manager-to-unscoped",
        ...
        "replacements:scorecard-registry-move",
        ...
        "replacements:temporalio-interceptors-opentelemetry-to-v2",
  ...
  "replacements:aws-sdk-smithy-client-to-smithy": {
    "namespace": "replacements",
    "description": "`@aws-sdk/smithy-client` was moved to `@smithy/smithy-client`.",
    "body": {
      "packageRules": [
        {
          "matchDatasources": [
          ...
          "replacementName": "@smithy/smithy-client",
  ...
  "replacements:corentinmusard-otel-cicd-action-to-dash0hq": {
    "namespace": "replacements",
  ...
  "replacements:dev-oidc-provider-to-unscoped": {
    "namespace": "replacements",
    "description": "`dev-oidc-provider` became unscoped.",
    "body": {
      "packageRules": [
        {
          ...
          "replacementName": "dev-oidc-provider",
          "replacementVersion": "2.0.0"
        }
      ]
    }
  ...
  "replacements:dev-process-manager-to-unscoped": {
    "namespace": "replacements",
    "description": "`dev-process-manager` became unscoped.",
    "body": {
      "packageRules": [
        {
          ...
          "replacementName": "dev-process-manager",
          "replacementVersion": "4.0.0"
        }
      ]
    }
  ...
  "replacements:scorecard-registry-move": {
    "namespace": "replacements",
    "description": "The OpenSSF Scorecard container images moved from `gcr.io/openssf/scorecard` to `ghcr.io/ossf/scorecard`.",
    "body": {
      "packageRules": [
        {
          "matchDatasources": [
          ...
          "replacementName": "ghcr.io/ossf/scorecard"
        }
      ]
    }
  },
  ...
  "replacements:temporalio-interceptors-opentelemetry-to-v2": {
    "namespace": "replacements",
    "description": "`@temporalio/interceptors-opentelemetry` was replaced by `@temporalio/interceptors-opentelemetry-v2`, which supports OpenTelemetry v2.",
    "body": {
      "packageRules": [
        {
          "matchCurrentVersion": ">=1.19.0",
          "matchDatasources": [
            "npm"
          ],
          "matchPackageNames": [
          ...
          "replacementName": "@temporalio/interceptors-opentelemetry-v2",
          "replacementVersion": "1.19.0"
        }
      ]
    }
  },
  ...
  "replacements:xlsx-to-scoped": {
    "namespace": "replacements",
    "description": "The `xlsx` package is now published as `@e965/xlsx`.",
    "body": {
      "packageRules": [
        {
          "matchCurrentVersion": "0.18.5",
          "matchDatasources": [
            "npm"
          ],
          "matchPackageNames": [
          ...
          "replacementName": "@e965/xlsx",
          "replacementVersion": "0.20.3"
        }
      ]
    }
  },
      ...
      "packageRules": [
        {
          ...
          "versioning": "regex:^(?<major>\\d+)\\.(?<minor>\\d+)\\.(?<patch>\\d+)(?:-security-(?<build>\\d+))?(?:-(?<compatibility>.*))?$"
        }
      ]
    }
  },
  "workarounds:groupings": {
    ...
    "body": {
      "packageRules": [
        {
          "description": "Group commander major updates, they depend on each other.",
          "groupName": "commander",
          "matchDatasources": [
            "npm"
          ],
  ...
  "workarounds:javaLTSVersions": {
    ...
    "body": {
      "packageRules": [
        ...
        {
          "description": "Use docker versioning for major-only Java image tags so rolling tags (e.g. 21-jre) are not upgraded to full-precision tags (e.g. 21.0.11_10-jre).",
          "matchCurrentValue": "/^\\d+(-|$)/",
          "matchDatasources": [
            "docker"
          ],
        ...
        {
          "description": "Use partial semver versioning for partial mise and GitHub Actions Java versions so rolling versions (e.g. 21) are not upgraded to full-precision versions (e.g. 21.0.11+9.0.LTS).",
