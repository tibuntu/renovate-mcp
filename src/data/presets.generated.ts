// AUTO-GENERATED by scripts/generate-presets.mjs from renovate@44.82.5.
...
export const RENOVATE_VERSION = "44.82.5";
  ...
  "workarounds:javaLTSVersions": {
    ...
    "body": {
      "packageRules": [
        ...
        {
          "description": "Use partial semver versioning for partial mise Java versions so rolling versions (e.g. 21) are not upgraded to full-precision versions (e.g. 21.0.11+9.0.LTS).",
